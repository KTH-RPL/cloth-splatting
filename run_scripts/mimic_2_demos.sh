...
python3 train.py -s "data/mimic/mimic_1_10_demos" --port $port --expname "mimic/mimic_1_2_demonstrations" --configs arguments/mdnerf-dataset/cube.py --lambda_w 100000 \
--lambda_rigidity 0.0 --lambda_spring 0.0  --lambda_momentum 0.0 \
--k_nearest 5 --lambda_isometric 0.0 --time_skip 9 \
--use_wandb --wandb_project "mimic_1" --wandb_name "2_demos_correspondance" \
