...
# python3 train_meshnet.py -s data/final_scenes/scene_1/ --port 6020 --expname "final_scenes/scene_1" --configs arguments/mdnerf-dataset/cube.py --lambda_w 100000 --lambda_rigidity $RIGIDITY_LAMBDA --lambda_spring $LAMBDA_SPRING --lambda_momentum 0.1 --use_wandb --wandb_project final_scene_1 --wandb_name big_exp --k_nearest 5 --lambda_isometric $LAMBDA_ISOMETRIC
...
# python3 train_meshnet.py -s data/final_scenes/scene_2/ --port 6021 --expname "final_scenes/scene_2" --configs arguments/mdnerf-dataset/cube.py --lambda_w 100000 --lambda_rigidity $RIGIDITY_LAMBDA --lambda_spring $LAMBDA_SPRING --lambda_momentum 0.1 --use_wandb --wandb_project final_scene_2 --wandb_name big_exp --k_nearest 5 --lambda_isometric $LAMBDA_ISOMETRIC
...
# python3 train_meshnet.py -s data/final_scenes/scene_3/ --port 6023 --expname "final_scenes/scene_3" --configs arguments/mdnerf-dataset/cube.py --lambda_w 100000 --lambda_rigidity $RIGIDITY_LAMBDA --lambda_spring $LAMBDA_SPRING  --lambda_momentum 0.1 --use_wandb --wandb_project final_scene_3 --wandb_name big_exp --k_nearest 5 --lambda_isometric $LAMBDA_ISOMETRIC
...
# python3 train_meshnet.py -s data/final_scenes/scene_6/ --port 6026 --expname "final_scenes/scene_6" --configs arguments/mdnerf-dataset/cube.py --lambda_w 100000 --lambda_rigidity $RIGIDITY_LAMBDA --lambda_spring $LAMBDA_SPRING  --lambda_momentum 0.1 --use_wandb --wandb_project final_scene_6 --wandb_name big_exp --k_nearest 5 --lambda_isometric $LAMBDA_ISOMETRIC
...
python3 render.py --model_path output/ablation/full/ --skip_train --skip_test --configs arguments/mdnerf-dataset/cube.py --view_skip 100 --flow_skip 5 --show_flow
...
python3 render.py --model_path output/ablation/no_rigid/ --skip_train --skip_test --configs arguments/mdnerf-dataset/cube.py --view_skip 100 --flow_skip 5 --show_flow
...
python3 render.py --model_path output/ablation/no_momentum/ --skip_train --skip_test --configs arguments/mdnerf-dataset/cube.py --view_skip 100 --flow_skip 5 --show_flow
...
python3 render.py --model_path output/ablation/no_iso/ --skip_train --skip_test --configs arguments/mdnerf-dataset/cube.py --view_skip 100 --flow_skip 5 --show_flow